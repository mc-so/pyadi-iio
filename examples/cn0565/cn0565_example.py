...
electrode_name = ["R26_C56_C57", # Electrode 0
...
def create_file(freq, frequency, amplitude, baudrate, real_impedance, imag_impedance):  
    ...
    while create != 'Y' or create != 'N':
        create = input("Would you like to generate a csv file? [Y/N] ") # ask user input
...
# DEVICE SETTINGS
#----------------------------------------------------------------------------------------------------
    cn0565 = adi.cn0565(uri="serial:COM6,230400,8n1n")
    ...
    create_file(cn0565.excitation_frequency, frequency, amplitude, baudrate, real_impedance, imag_impedance)
